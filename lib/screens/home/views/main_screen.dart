        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text('Welcome!', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: colorScheme.outline)),
                        Text('User', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: colorScheme.onBackground)),
                      ],
                    ),
                  ],
                ),
                IconButton(
                  ...
                  icon: Icon(CupertinoIcons.settings, color: colorScheme.onBackground),
                )
              ],
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('৳ $totalBalance.00', style: const TextStyle(fontSize: 40, color: Colors.white, fontWeight: FontWeight.bold)),
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        // Income
                        GestureDetector(
                          onTap: () => _showInputDialog('Update Income', _incomeController, (value) {
                            setState(() => totalIncome = value);
                          }),
                          child: Row(
                            children: [
                              const CircleAvatar(
                                ...
                                child: Icon(CupertinoIcons.arrow_up, size: 12, color: Colors.greenAccent),
                              ),
                              const SizedBox(width: 8),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Text('৳ $totalIncome.00', style: const TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w600)),
                                ],
                              ),
                            ],
                          ),
                        ...
                        // Expenses
                        GestureDetector(
                          onTap: () => _showInputDialog('Update Expenses', _expensesController, (value) {
                            setState(() => totalExpenses = value);
                          }),
                          child: Row(
                            children: [
                              const CircleAvatar(
                                radius: 12.5,
                                backgroundColor: Colors.white30,
                                child: Icon(CupertinoIcons.arrow_down, size: 12, color: Colors.red),
                              ),
                              const SizedBox(width: 8),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Text('৳ $totalExpenses.00', style: const TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w600)),
                                ],
                              ),
                            ],
                          ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('Transactions', style: TextStyle(fontSize: 16, color: colorScheme.onBackground, fontWeight: FontWeight.bold)),
                GestureDetector(
                  onTap: () {},
                  child: Text('View All', style: TextStyle(fontSize: 14, color: colorScheme.outline, fontWeight: FontWeight.w400)),
                )
              ],
            ),
